...
module.exports.handleCallback = (req, res, next) => {
    ...
    if (!code) return res.redirect('https://zippy-douhua-deac4c.netlify.app/index.html?spotify=error');
    ...
    .then(function(r) {
        userModel.saveSpotifyTokens({
            ...
            if (err) return res.redirect('https://zippy-douhua-deac4c.netlify.app/index.html?spotify=error');
            res.redirect('https://zippy-douhua-deac4c.netlify.app/index.html?spotify=connected');
        });
    })
    .catch(function(e) {
        console.error('Callback error:', e.response ? e.response.data : e.message);
        res.redirect('https://zippy-douhua-deac4c.netlify.app/index.html?spotify=error');
    });
};
